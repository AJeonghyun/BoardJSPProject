...
<nav class="navbar navbar-light col-12">
	<div class="container-fluid">
		...
		<form class="d-flex">
			...
			<button class="btn btn-success me-2" type="button" onclick="location.href='addpostform.jsp'">Add</button>
...
<c:forEach items="${list}" var="u" varStatus="status">
	<tr >
		...
		<td class="align-middle">${u.getSeq()}</td>
		<td class="align-middle"><c:if test="${u.getPhoto() ne ''}"><br/>
			<img src="${pageContext.request.contextPath}/upload/${u.getPhoto()}" width="200px" height="200px" class="photo"></c:if></td>
		<td class="align-middle">${u.getCategory()}</td>
		<td class="align-middle">${u.getTitle()}</td>
		<td class="align-middle">${u.getWriter()}</td>
		<td class="align-middle">${u.getContent()}</td>
		<td class="align-middle">${u.getRegdate()}</td>
		<td class="align-middle">
			<a href="editform.jsp?id=${u.getSeq()}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
